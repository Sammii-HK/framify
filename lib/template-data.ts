...
export interface Template {
  ...
  buyUrl?: string   // Lemon Squeezy product URL — set once store is live
...
export const templates: Template[] = [
  // Single-page — $15 each
  { type: 'standard', name: 'Standard', description: 'A clean, versatile layout that works for any business. Hero section, services grid, testimonials, and contact form.', bestFor: 'Any business', pages: 'single', mockupStyle: 'grid-3', category: 'services', price: 15 },
  { type: 'trades', name: 'Trades and Services', description: 'Built for businesses that work with their hands. Project gallery, service area map, and quote request form.', bestFor: 'Plumbers, builders, electricians, roofers', pages: 'single', mockupStyle: 'split-gallery', category: 'services', price: 15 },
  { type: 'hair-beauty', name: 'Hair and Beauty', description: 'Designed to showcase your craft. Portfolio grid, price list, and booking integration ready.', bestFor: 'Salons, spas, barbers, nail techs', pages: 'single', mockupStyle: 'gallery-4', category: 'health-wellness', price: 15 },
  { type: 'food-drink', name: 'Food and Drink', description: 'Put your menu front and centre. Opening hours, location map, and reservation links included.', bestFor: 'Restaurants, cafes, pubs, bakeries', pages: 'single', mockupStyle: 'menu-list', category: 'food-hospitality', price: 15 },
  { type: 'portfolio', name: 'Portfolio', description: 'Let your work do the talking. Full-width image grid, case studies, and a minimal aesthetic.', bestFor: 'Photographers, designers, artists, videographers', pages: 'single', mockupStyle: 'grid-6', category: 'creative', price: 15 },
  { type: 'professional', name: 'Professional', description: 'Establish authority and trust. Credentials section, client logos, and a clean content-first layout.', bestFor: 'Consultants, coaches, accountants, solicitors', pages: 'single', mockupStyle: 'grid-3', category: 'professional', price: 15 },
  { type: 'health-fitness', name: 'Health and Fitness', description: 'Class timetable, trainer profiles, and booking integration. Built for active businesses.', bestFor: 'Personal trainers, gyms, yoga studios, sports coaches', pages: 'single', mockupStyle: 'timetable', category: 'health-wellness', price: 15 },
  { type: 'events', name: 'Events and Entertainment', description: 'Showcase your showreel, list packages, and let clients check availability.', bestFor: 'DJs, entertainers, venues, event planners', pages: 'single', mockupStyle: 'hero-wide', category: 'food-hospitality', price: 15 },
  { type: 'pet-services', name: 'Pet Services', description: 'Service area map, pricing tiers, and a gallery that wins hearts. Built for animal lovers.', bestFor: 'Dog groomers, walkers, vets, pet sitters', pages: 'single', mockupStyle: 'gallery-4', category: 'services', price: 15 },
  { type: 'automotive', name: 'Automotive', description: 'MOT and service lists, before-and-after gallery, and quote request form.', bestFor: 'Garages, detailers, car dealers, mechanics', pages: 'single', mockupStyle: 'split-gallery', category: 'services', price: 15 },
  { type: 'education', name: 'Education and Tutoring', description: 'Subject grid, qualification badges, testimonials, and booking form.', bestFor: 'Tutors, training providers, music teachers, driving instructors', pages: 'single', mockupStyle: 'grid-3', category: 'professional', price: 15 },
  { type: 'property', name: 'Property and Lettings', description: 'Listings grid, valuation request form, and area guides. Built for the property market.', bestFor: 'Estate agents, landlords, property managers', pages: 'single', mockupStyle: 'listings', category: 'professional', price: 15 },
  { type: 'medical', name: 'Medical and Dental', description: 'Service list, team credentials, patient booking, and trust signals throughout.', bestFor: 'Clinics, dentists, physios, opticians', pages: 'single', mockupStyle: 'grid-3', category: 'health-wellness', price: 15 },
  { type: 'creative-agency', name: 'Creative Agency', description: 'Bold case studies, client logos, team section, and a strong visual identity.', bestFor: 'Design studios, marketing agencies, dev shops', pages: 'single', mockupStyle: 'hero-wide', category: 'creative', price: 15 },
  { type: 'shop', name: 'Shop', description: 'Product grid, category filters, and a clean layout ready for e-commerce integration.', bestFor: 'Boutiques, gift shops, artisan sellers, online stores', pages: 'single', mockupStyle: 'product-grid', category: 'retail', price: 15 },
  // Multi-page — $29 each
  { type: 'business-pro', name: 'Business Pro', description: 'A full multi-page website with Home, About, Services, Blog, and Contact pages. Everything a growing business needs.', bestFor: 'Established businesses, agencies, consultancies', pages: 'multi', pageCount: 6, mockupStyle: 'multi-tabs', category: 'professional', price: 29 },
  { type: 'startup', name: 'Startup', description: 'Landing page with product features, pricing table, team profiles, blog, and a clear sign-up funnel.', bestFor: 'SaaS startups, tech companies, app launches', pages: 'multi', pageCount: 5, mockupStyle: 'multi-tabs', category: 'tech', price: 29 },
  { type: 'restaurant-full', name: 'Restaurant Full', description: 'Multi-page site with dedicated menu, gallery, events, reservations, and about pages.', bestFor: 'Restaurants, bars, hotels, catering businesses', pages: 'multi', pageCount: 6, mockupStyle: 'multi-tabs', category: 'food-hospitality', price: 29 },
  { type: 'portfolio-full', name: 'Portfolio Full', description: 'Multi-page portfolio with individual case study pages, an about section, blog, and contact form.', bestFor: 'Freelancers, architects, interior designers', pages: 'multi', pageCount: 5, mockupStyle: 'multi-tabs', category: 'creative', price: 29 },
  { type: 'clinic', name: 'Clinic', description: 'Full clinic site with service pages, team profiles, patient information, FAQs, and booking.', bestFor: 'Dental practices, physio clinics, veterinary surgeries', pages: 'multi', pageCount: 7, mockupStyle: 'multi-tabs', category: 'health-wellness', price: 29 },
  { type: 'property-full', name: 'Property Full', description: 'Multi-page site with listings, area guides, valuation tool, team profiles, and blog.', bestFor: 'Estate agents, letting agencies, property developers', pages: 'multi', pageCount: 6, mockupStyle: 'multi-tabs', category: 'professional', price: 29 },
]
