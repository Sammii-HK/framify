...
export default function DashboardPage() {
  ...
  }, [search, filterStyle, user, router]);
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-6">
            ...
            <select
              ...
              className="px-4 py-3 border border-gray-300 rounded-framer focus:ring-2 focus:ring-sky-400 focus:border-transparent outline-none transition-all bg-white min-w-[200px]"
            >
